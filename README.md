...
- Multiple visualisation requirements: creating clear, meaningful plots across many variables required iterative refinement. Seaborn and Matplotlib were used in combination, with automation of subplot generation and consistent labelling to improve readability and reproducibility.
